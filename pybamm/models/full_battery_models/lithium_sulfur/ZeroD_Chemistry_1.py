...
class ZeroD_Chemistry_1(BaseModel):
    """
    ...
    def __init__(self, options=None, name="Zero Dimensional Model with Chemistry 1"):
        ...
        # Differential equation (8b) in [2] (set f_s = 0 to retrieve Marinescu et al. (2016) and Hua et al. (2019))

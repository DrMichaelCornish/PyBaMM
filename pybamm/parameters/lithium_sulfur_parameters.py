...
class LithiumSulfurParameters:
    ...
    def __init__(self):
        ...
        self.S8p_initial = pybamm.Parameter("Initial Condition for S8p [g]")
        self.S6_initial = pybamm.Parameter("Initial Condition for S6 ion [g]")
        ...
        self.av0 = pybamm.Parameter("Initial Specific Surface Area [m-1]")
        ...
        self.gamma = pybamm.Parameter("gamma")